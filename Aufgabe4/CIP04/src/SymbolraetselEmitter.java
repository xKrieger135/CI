...
public static class STAttrMap extends HashMap {
  ...
  public STAttrMap put(String attrName, int value) {
    ...
    public String getGrammarFileName() { return "C:\\Users\\patrick_steinhauer\\Documents\\GitHub\\CI\\Aufgabe4\\SymbolRaetselSolver\\SymbolraetselEmitter.g"; }
    ...
    public final SymbolraetselEmitter.puzzle_return puzzle() throws RecognitionException {
        ...
        try {
            // C:\\Users\\patrick_steinhauer\\Documents\\GitHub\\CI\\Aufgabe4\\SymbolRaetselSolver\\SymbolraetselEmitter.g:29:3: ( ^( SYMBOLPUZZLE aufgabe1= sammeleSymbole aufgabe2= sammeleSymbole aufgabe3= sammeleSymbole aufgabe4= sammeleSymbole aufgabe5= sammeleSymbole aufgabe6= sammeleSymbole ) -> sums(uebergabeConstraint=$constraintsuebergabeBuchstaben=$buchstaben))
            // C:\\Users\\patrick_steinhauer\\Documents\\GitHub\\CI\\Aufgabe4\\SymbolRaetselSolver\\SymbolraetselEmitter.g:29:6: ^( SYMBOLPUZZLE aufgabe1= sammeleSymbole aufgabe2= sammeleSymbole aufgabe3= sammeleSymbole aufgabe4= sammeleSymbole aufgabe5= sammeleSymbole aufgabe6= sammeleSymbole )
            {
            match(input,SYMBOLPUZZLE,FOLLOW_SYMBOLPUZZLE_in_puzzle85); 
            ...
            pushFollow(FOLLOW_sammeleSymbole_in_puzzle105);
            aufgabe5=sammeleSymbole();

            state._fsp--;


            pushFollow(FOLLOW_sammeleSymbole_in_puzzle109);
            ...
            match(input, Token.UP, null); 
             	...
             	retval.constraints.add((aufgabe3!=null?aufgabe3.st:null).toString());
              	...
              	retval.constraints.add((aufgabe6!=null?aufgabe6.st:null).toString());
              

            // TEMPLATE REWRITE
            // 49:3: -> sums(uebergabeConstraint=$constraintsuebergabeBuchstaben=$buchstaben)
            {
    ...
    // C:\\Users\\patrick_steinhauer\\Documents\\GitHub\\CI\\Aufgabe4\\SymbolRaetselSolver\\SymbolraetselEmitter.g:54:1: sammeleSymbole returns [Set<String> gesammelteSymbole] : ^( GLEICH ( ^( PLUS wort1= wort wort2= wort ) wort3= wort ) ) -> sum(ersteswort=$wort1.numberzweiteswort=$wort2.numberergebniswort=$wort3.number);
    public final SymbolraetselEmitter.sammeleSymbole_return sammeleSymbole() throws RecognitionException {
        ...
        try {
            // C:\\Users\\patrick_steinhauer\\Documents\\GitHub\\CI\\Aufgabe4\\SymbolRaetselSolver\\SymbolraetselEmitter.g:74:4: ( ^( GLEICH ( ^( PLUS wort1= wort wort2= wort ) wort3= wort ) ) -> sum(ersteswort=$wort1.numberzweiteswort=$wort2.numberergebniswort=$wort3.number))
            // C:\\Users\\patrick_steinhauer\\Documents\\GitHub\\CI\\Aufgabe4\\SymbolRaetselSolver\\SymbolraetselEmitter.g:74:7: ^( GLEICH ( ^( PLUS wort1= wort wort2= wort ) wort3= wort ) )
            {
            match(input,GLEICH,FOLLOW_GLEICH_in_sammeleSymbole158); 

            match(input, Token.DOWN, null); 
            // C:\\Users\\patrick_steinhauer\\Documents\\GitHub\\CI\\Aufgabe4\\SymbolRaetselSolver\\SymbolraetselEmitter.g:74:16: ( ^( PLUS wort1= wort wort2= wort ) wort3= wort )
            // C:\\Users\\patrick_steinhauer\\Documents\\GitHub\\CI\\Aufgabe4\\SymbolRaetselSolver\\SymbolraetselEmitter.g:74:17: ^( PLUS wort1= wort wort2= wort ) wort3= wort
            {
            match(input,PLUS,FOLLOW_PLUS_in_sammeleSymbole162); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_wort_in_sammeleSymbole166);
            wort1=wort();

            state._fsp--;


            pushFollow(FOLLOW_wort_in_sammeleSymbole170);
            wort2=wort();
            ...
            pushFollow(FOLLOW_wort_in_sammeleSymbole175);
            wort3=wort();
            ...
            // TEMPLATE REWRITE
            // 74:60: -> sum(ersteswort=$wort1.numberzweiteswort=$wort2.numberergebniswort=$wort3.number)
            {
    ...
    // $ANTLR start "wort"
    // C:\\Users\\patrick_steinhauer\\Documents\\GitHub\\CI\\Aufgabe4\\SymbolRaetselSolver\\SymbolraetselEmitter.g:80:1: wort returns [Number number] : ^( WORT (buchstaben+= BUCHSTABEN )+ ) ;
    public final SymbolraetselEmitter.wort_return wort() throws RecognitionException {
        ...
        try {
            // C:\\Users\\patrick_steinhauer\\Documents\\GitHub\\CI\\Aufgabe4\\SymbolRaetselSolver\\SymbolraetselEmitter.g:85:2: ( ^( WORT (buchstaben+= BUCHSTABEN )+ ) )
            // C:\\Users\\patrick_steinhauer\\Documents\\GitHub\\CI\\Aufgabe4\\SymbolRaetselSolver\\SymbolraetselEmitter.g:85:6: ^( WORT (buchstaben+= BUCHSTABEN )+ )
            {
            match(input,WORT,FOLLOW_WORT_in_wort228); 

            match(input, Token.DOWN, null); 
            // C:\\Users\\patrick_steinhauer\\Documents\\GitHub\\CI\\Aufgabe4\\SymbolRaetselSolver\\SymbolraetselEmitter.g:85:23: (buchstaben+= BUCHSTABEN )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
            	...
            	case 1 :
            	    // C:\\Users\\patrick_steinhauer\\Documents\\GitHub\\CI\\Aufgabe4\\SymbolRaetselSolver\\SymbolraetselEmitter.g:85:23: buchstaben+= BUCHSTABEN
            	    {
            	    buchstaben=(CommonTree)match(input,BUCHSTABEN,FOLLOW_BUCHSTABEN_in_wort232); 
    ...
    public static final BitSet FOLLOW_SYMBOLPUZZLE_in_puzzle85 = new BitSet(new long[]{0x0000000000000004L});
    ...
    public static final BitSet FOLLOW_sammeleSymbole_in_puzzle101 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_sammeleSymbole_in_puzzle105 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_sammeleSymbole_in_puzzle109 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_GLEICH_in_sammeleSymbole158 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_PLUS_in_sammeleSymbole162 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_wort_in_sammeleSymbole166 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_wort_in_sammeleSymbole170 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_wort_in_sammeleSymbole175 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_WORT_in_wort228 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_BUCHSTABEN_in_wort232 = new BitSet(new long[]{0x0000000000000018L});
